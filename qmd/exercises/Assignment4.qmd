...
#| echo: false
#| eval: false
data3 = cbind(c(11,24),c(11,11),c(1,0))
data3
chisq.test(data3)

data2 = cbind(c(11,24),c(12,11))
data2
chisq.test(data2)
```
...
#| echo: false
#| eval: false
data4 = cbind(c(6,14,21),c(73,65,58),c(55,82,48),c(7,8,8))
data4
chisq.test(data4)
...
#| echo: false
#| eval: false
values = c(35, 42, 42, 30, 15, 31, 29, 29, 17,
            34, 38, 26, 17, 42, 28, 35, 33, 16,
            17, 29, 30, 36, 41, 30, 31, 23, 38)
samples = gl(3,9)

library(agricolae)
Median.test(values,samples)
```
...
#| echo: false
#| eval: false
values = c(73,64,67,62,84 ,80 ,81,77,82 ,79,71,75) 
samples = gl(3,4)

library(agricolae)
Median.test(values,samples)

kruskal.test(values,samples)
kwAllPairsConoverTest(values,samples,p.adjust.method = "bon")
```
...
#| echo: false
#| eval: false
Husband.X = c(25,21,38,64,52,16,26)
Wife.Y    = c(16,42,56,41,19,26,24) 
# D= Y-X
wilcox.test(Wife.Y,Husband.X,
            alternative = "l", paired = TRUE)

...
```{r}
hw = (1:12)
grass1 = c(4,4,3,3,4,2,1,2,3.5,4,4,3.5)
grass2 = c(3,2,1.5,1,2,2,3,4,1,1,2,1)
grass3 = c(2,3,1.5,2,1,2,2,1,2,3,3,2)
grass4 = c(1,1,4,4,3,4,4,3,3.5,2,1,3.5)
...
cor.test(gmat,gpa,method = "s",alternative = "g")
